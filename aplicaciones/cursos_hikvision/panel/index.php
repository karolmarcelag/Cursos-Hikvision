    ...
    <html lang="en-US">
        ...
        <body onload='cargar_region(1)'>
            ...
            <div class='buscar' style='margin-top:60px'>
                <button id='boton_agregar1' class='input_boton' style='float:left; position:absolute; left:0%; margin:auto; width:10%; cursor:hand; display:block;' onclick='abrir_formulario()'>Agregar Curso</button>
